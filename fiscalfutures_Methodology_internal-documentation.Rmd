...
```{r}
top3 <- rev_long  %>% filter(Category == "02" | Category == "03" | Category == "06") %>%
  ggplot()+geom_line(aes(x=Year, y=Dollars, color = Category)) + 
  labs(title = "Top 3 Own Source Revenues", subtitle = "Individual Income Taxes, Corporate income taxes, and Sales Taxes")
...
ggplot() + 
  geom_line(data = ownsource_rev, aes(x=Year, y=Dollars), color = "Green") + 
  geom_line(data = fed_rev, aes(x=fy, y=fed_total), color = "Blue") + labs(title = "Own Source Revenue and Federal Transfers", caption = "Green is own source revenues,
                                                                           Blue is federal transfers.")
```

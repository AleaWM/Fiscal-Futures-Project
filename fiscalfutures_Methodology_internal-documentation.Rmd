...
- State pension contributions are largely captured with object=4431. **(These are the State expemditures included in analysis)**     
...
- Some expenditures with object=4430 (benefits paid to retirees) were paid for with Pension obligation bond funds (fund == 0825). In past years, some POB funded expenditures were moved to revenue side. Code logic was unclear. We are no longer doing this as of FY2021.   

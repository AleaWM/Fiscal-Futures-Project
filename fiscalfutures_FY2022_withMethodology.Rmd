...
- object = 1298 is purchase of investments and is excluded from analysis  
...
Purchase of investments is dropped from the analysis, but should it be?
Examine what is considered "Purchase of Investments" object == "1298"
```{r}
...
[Link](https://www.ilga.gov/legislation/ilcs/documents/003003300K7.7.htm)
...
8800 is for tollway **Include debt principle and interest as cost, bond proceeds are not revenue**

- Include: Bond principle payments: obj_seq_type == 88110008  
...
- Include: tollway Principal AND Interest: obj_seq_type == 88000055   
...
exp_temp %>% filter(fund == "0455") %>% group_by(fy) %>% summarize(sum = sum(expenditure))
rev_temp %>% filter(fund == "0455") %>% group_by(fy) %>% summarize(sum = sum(receipts))
```
...
# CLAIMS, FRATERNAL ORDER OF POLICE
# 1175 doesnt exist?
in_from_out <- c("0847", "0867", "1175", "1176", "1177", "1178", "1181", "1182", "1582", "1592", "1745", "1982", "2174", "2264")

...
ggplot()+
  ...
  labs(title="Pension fund inflows and outflows", 
       caption = "Based on rev_type = 51 for employee and employer contributions into the fund,
       object=4430 for benefits paid out of funds, 
       and object=4431 for state contributions into pension fund", y = "Dollars")
```
...
ggplot()+
  ...
  labs(title="Tollway bond procreeds, debt service, revenue, and expenditures.", 
       caption = "Tollway fund 0455.
       Revenue line does not include bond proceeds.", 
       y = "Dollars")
```

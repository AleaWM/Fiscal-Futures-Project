...
- State employee contributions should be subtracted from state healthcare expenditures. State employer contributions should be dropped to avoid double counting costs.   
...
ff_exp<- ff_exp %>% select(-c(debt_cost, healthcare_cost, employee_premiums_sum, exp_971:exp_976)) # drop unwanted columns
ff_exp
```

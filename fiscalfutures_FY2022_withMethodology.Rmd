...
Looking only at general obligation principal payemnts and interest payments:
...
health_insurance_fund_rev %>% 
  ggplot(aes(x=fy, y = health_ins_rev)) + geom_line() + labs( title = "Health insurance fund - All revenue")
...
emp_premium %>% ggplot(aes(x=fy, y = employee_premiums_sum)) + geom_line() + labs( title = "Employee health insurance premiums")
...
- State employer group insurance contributions should be dropped to avoid double counting costs.    

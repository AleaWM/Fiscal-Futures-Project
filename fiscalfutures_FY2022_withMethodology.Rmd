...
- Pension obligation acceleration bond, state pension obligation bond reimbursements, pension pickup, accelerated pension buy-out (bond financced funds)
...
ggplot()+
  geom_line(data=retirement_contributions, aes(x=fy, y=contributions)) +
  geom_line(data= pension_exp, aes(x=fy, y = expenditure))+ 
  labs(title="Retirement revenue sources and benefits paid to employees", caption = "Based on rev_type = 51 for revenue and object=4430 for expenditures.", y = "Dollars")
```

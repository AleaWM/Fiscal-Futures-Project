...
- 75.  Inter-Agency Receipts.     __(Only from Funds excluded from Fiscal Futures) - What does that actually mean?__
...
ff_rev <- ff_rev %>%
  ...
  select(-c(ref_02:ref_35, rev_78, rev_99, rev_NA, rev_76#, pension_amt , rev_76,
          #  , eehc
            ))

...
- object = 1298 is for Purchase of Investments and is excluded from analysis except for a couple exceptions during 2010 and 2011.  
- object = 1900 for pension stabilization under lump sums  
- object = 1167 and 1168 is for Employer pension contributions but is not used as of FY2022.  
...
```{r}
rev_long <- read_csv("expenditures_recoded_long_FY22.csv")
exp_long <- read_csv("revenue_recoded_long_FY22.csv")
